...
/**
 * La clase Cuadrado representa un tetramino que tiene la forma de una forma en Z.
 * Extiende la clase Tetramino y se utiliza para representar dicho tetramino en el tablero del juego.
 */
public class Zeta extends Tetramino{
    //Nombre por defecto de los objetos de esta clase
    private static final String NOMBRE_POR_DEFECTO = "Zeta";
    /**
     * Crea un nuevo objeto zeta en la posición especificada.
     *
    ...
    public Zeta(int posicionX, int posicionY) {
