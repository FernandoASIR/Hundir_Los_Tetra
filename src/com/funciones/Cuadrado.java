...
/**
 * La clase Cuadrado representa un tetramino que tiene la forma de un cuadrado.
 * Extiende la clase Tetramino y se utiliza para representar dicho tetramino en el tablero del juego.
 */
public class Cuadrado extends Tetramino {
    //Nombre por defecto de los objetos de esta clase
    private static final String NOMBRE_POR_DEFECTO = "Cuadrado";

    /**
     * Crea un nuevo objeto Cuadrado en la posición especificada.
     *
    ...
    public Cuadrado(int posicionX, int posicionY) {
    ...
    public void construirNorte(int posicionX, int posicionY, Tablero tablero) {
        ...
        if (comprobarLimite(nextX + 1, nextY) && tablero.comprobarCasilla(nextX, nextY + 1, Estado.AGUA)) {
            contadorOK++;
        }
     ...
     * Al colocarse en una situacion igual al sur se establece que este metodo sea igual.
     *
     * @param posicionX la posición X del tetramino en el tablero
     * @param posicionY la posición Y del tetramino en el tablero
     * @param tablero   el tablero en el que se construye el tetramino
    ...
    public void construirEste(int posicionX, int posicionY, Tablero tablero) {
        construirSur(posicionX, posicionY, tablero);
    }
